...
export const ERROR_MESSAGES = {
    ...
    VENV_NOT_INSTALLED:
        'Python venv module is not available. The extension will try to install virtualenv in user site-packages.',
    GITINGEST_NOT_INSTALLED:
        'GitIngest package installation failed. Please ensure you have internet connectivity and try again.',
